    ...
    <div className="p-4 sm:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      {activeTab === 'history' && (
        <div className="space-y-6">
          ...
          {/* History Filter & Action Toolbar */}
          <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            {/* Top Row: Period Tabs + Jenjang & Payment Method Filters */}
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 pb-3 border-b border-slate-100">
              ...
              <div className="flex items-center gap-1.5 bg-slate-100/90 p-1 rounded-2xl overflow-x-auto">
                {[
              ...
              {/* Dropdown Filters (Jenjang & Metode) */}
              <div className="flex items-center gap-2.5 flex-wrap">
                {/* Jenjang Filter */}
                <div className="flex items-center gap-1.5">
                  <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider hidden sm:inline">Jenjang:</span>
                  <select
                    value={historyUnit}
                    onChange={(e) => setHistoryUnit(e.target.value)}
                    className="px-3.5 py-2 bg-slate-50 hover:bg-slate-100/80 border border-slate-200 text-slate-800 rounded-xl text-xs font-bold focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all cursor-pointer"
                  >
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider hidden sm:inline">Metode:</span>
                  <select
                    value={historyMethod}
            ...
            {/* Bottom Row: Search Bar + Consolidated Action Buttons */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Cari nomor kuitansi, nama siswa, atau NIS..."
                  className="w-full pl-10 pr-9 py-2.5 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 rounded-2xl text-xs font-medium focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all placeholder:text-slate-400"
                />
                {historySearch && (
                  <button 
              ...
              <div className="flex items-center gap-2.5 shrink-0 justify-end">
                <button
                  ...
                  className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 font-extrabold text-xs rounded-2xl border border-slate-200 transition-all flex items-center gap-2 cursor-pointer active:scale-95 shadow-xs whitespace-nowrap"
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs rounded-2xl shadow-md shadow-emerald-600/20 transition-all flex items-center gap-2 cursor-pointer active:scale-95 whitespace-nowrap"
